...
export function assetUrl(path) {
  ...
  if (baseClean) {
    while (cleaned.startsWith(baseClean + '/')) {
      cleaned = cleaned.slice(baseClean.length + 1);
    }
  }
  return BASE + cleaned;
}
...
export const PRODUCTS = [
  {
    id: '200ml-case',
    title: '200ml Case (78 Pack)',
    subtitle: 'Events, Airlines & Hospitality Mini Bottles',
    description: 'Compact 200ml bottles in a master carton of 78. The ideal serving size for conferences, weddings, flights, hotels, and premium hospitality experiences.',
    pricePerCase: 585.00,
    price: 585.00,
    unitPrice: 7.50,
